                    ...
                    <td className="px-4 py-3.5">
                      {c.report_status === 'done' && (
                        <div className="flex items-center gap-2">
                          ...
                          {c.report_has_html && (
                            <a
                              href={`/api/coachee/${c.id}/report/html`}
                              target="_blank"
                              rel="noopener"
                              onClick={(e) => e.stopPropagation()}
                              className="inline-flex items-center gap-1.5 px-3 py-1.5 text-[11px] font-medium
                                         text-[#40A2C0] bg-[rgba(64,162,192,0.08)] border border-[rgba(64,162,192,0.3)]
                                         rounded-full no-underline transition-all
                                         hover:bg-[rgba(64,162,192,0.18)] hover:border-[#40A2C0] hover:-translate-y-px"
                            >
                              <img src="/img/magazine.svg" width="16" height="16" alt="" />
                              {t('list.reportHtml')}
                            </a>
                          )}
                        </div>
